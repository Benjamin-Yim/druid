...
public class StarrocksSelectParser extends SQLSelectParser {
    public StarrocksSelectParser(SQLExprParser exprParser) {
    ...
    public SQLSelectQuery query(SQLObject parent, boolean acceptUnion) {
        ...
        StarrocksSelectQueryBlock queryBlock = new StarrocksSelectQueryBlock();
    ...
    public void parseTableSourceSampleStarrocks(SQLTableSource tableSource) {
    ...
    public void parseTableSourceSample(SQLTableSource tableSource) {
        parseTableSourceSampleStarrocks(tableSource);
    }
}
