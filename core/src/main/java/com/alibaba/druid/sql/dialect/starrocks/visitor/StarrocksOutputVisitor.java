...
//    }
    ...
    @Override
    public boolean visit(StarrocksUDTFSQLSelectItem x) {
    ...
    @Override
    public boolean visit(StarrocksAddStatisticStatement x) {
    ...
    @Override
    public boolean visit(StarrocksRemoveStatisticStatement x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.TableCount x) {
        print0(ucase ? "TABLE_COUNT" : "table_count");
        return false;
    }

    @Override
    public boolean visit(StarrocksStatisticClause.ExpressionCondition x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.NullValue x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.DistinctValue x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.ColumnSum x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.ColumnMax x) {
    ...
    @Override
    public boolean visit(StarrocksStatisticClause.ColumnMin x) {
    ...
    @Override
    public boolean visit(StarrocksReadStatement x) {
        List<SQLCommentHint> headHints = x.getHeadHintsDirect();
        if (headHints != null) {
            for (SQLCommentHint hint : headHints) {
                visit((SQLCommentHint) hint);
    ...
    @Override
    public boolean visit(StarrocksShowGrantsStmt x) {
        List<SQLCommentHint> headHints = x.getHeadHintsDirect();
        if (headHints != null) {
            for (SQLCommentHint hint : headHints) {
                visit((SQLCommentHint) hint);
    ...
    @Override
    public boolean visit(StarrocksListStmt x) {
    ...
    @Override
    public boolean visit(StarrocksGrantStmt x) {
    ...
    @Override
    public boolean visit(StarrocksAddFileStatement x) {
        print0(ucase ? "ADD " : "add ");

        StarrocksAddFileStatement.FileType type = x.getType();
        switch (type) {
            case JAR:
    ...
    @Override
    public boolean visit(StarrocksAlterTableSetFileFormat x) {
    ...
    @Override
    public boolean visit(StarrocksQueryAliasStatement x) {
        print0(x.getVariant());
        print0(" := ");
    ...
    @Override
    public boolean visit(StarrocksTransformExpr x) {
    ...
    @Override
    public boolean visit(StarrocksNewExpr x) {
        print0("new ");
        super.visit((SQLMethodInvokeExpr) x);
        return false;
    }

    public boolean visit(StarrocksInstallPackageStatement x) {
