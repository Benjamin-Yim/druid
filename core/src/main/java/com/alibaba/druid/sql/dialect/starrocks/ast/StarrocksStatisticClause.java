...
public abstract class StarrocksStatisticClause extends StarrocksObjectImpl {
    public abstract static class ColumnStatisticClause extends StarrocksStatisticClause {
    ...
    public static class ExpressionCondition extends StarrocksStatisticClause {
    ...
    public static class TableCount extends StarrocksStatisticClause {
        @Override
        public void accept0(StarrocksASTVisitor visitor) {
            visitor.visit(this);
            visitor.endVisit(this);
