...
public class StarrocksSelectTest28 extends TestCase {
    public void test_select() throws Exception {
        // 1095288847322
        String sql = "-- 注释\n" +
                "read bigdata_xy.dual 10;";//
        assertEquals("-- 注释\n" +
                "READ bigdata_xy.dual 10;", SQLUtils.formatStarrocks(sql));

        assertEquals("-- 注释\n" +
                "read bigdata_xy.dual 10;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
