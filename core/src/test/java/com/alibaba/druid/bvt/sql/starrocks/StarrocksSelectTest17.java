...
public class StarrocksSelectTest17 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT prov, name, cnt\n" +
                ...
                "\t)\n" +
                "ORDER BY cnt DESC\n" +
                "LIMIT 800", SQLUtils.formatStarrocks(sql));
        assertEquals("select prov, name, cnt\n" +
                "from mock_app.adl_mock_v_fct\n" +
                "where ds = 20160920\n" +
                "\tand name != 'none'\n" +
                ...
                "\t)\n" +
                "order by cnt desc\n" +
                "limit 800", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
