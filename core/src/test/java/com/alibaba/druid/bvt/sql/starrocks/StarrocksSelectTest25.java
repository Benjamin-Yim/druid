...
public class StarrocksSelectTest25 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("INSERT OVERWRITE TABLE ids_openapp_dau_d PARTITION (dt='${lastday}')\n" +
                ...
                "AND tt.ver <> 'all')\n" +
                "GROUP BY tt.os, \n" +
                "\ttt.ver;", SQLUtils.formatStarrocks(sql));
        ...
        assertEquals("insert overwrite table ids_openapp_dau_d partition (dt='${lastday}')\n" +
                ...
                "and tt.ver <> 'all')\n" +
                "group by tt.os, \n" +
                "\ttt.ver;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
