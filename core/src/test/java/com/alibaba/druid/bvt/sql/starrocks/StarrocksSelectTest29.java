...
public class StarrocksSelectTest29 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("-- aaaaa\n" +
                "SELECT * -- hhhhh\n" +
                "FROM emp e\n" +
                "LEFT OUTER JOIN emp_datahub", SQLUtils.formatStarrocks(sql));

        assertEquals("-- aaaaa\n" +
                "select * -- hhhhh\n" +
                "from emp e\n" +
                "left outer join emp_datahub", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
