...
public class StarrocksSelectTest33 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT *\n" +
                ...
                "ON a.id = b.id;", SQLUtils.formatStarrocks(sql));

        assertEquals("select *\n" +
                "from mytable1 a\n" +
                "left anti join mytable2 b\n" +
                "on a.id = b.id;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
