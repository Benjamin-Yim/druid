...
public class StarrocksSelectTest10 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT /*+ mapjoin(a) */ a.name, b.fals\n" +
                "FROM abc a\n" +
                "JOIN abc1 b\n" +
                "ON a.name = b.fals;", SQLUtils.formatStarrocks(sql));
        assertEquals("select /*+ mapjoin(a) */ a.name, b.fals\n" +
                "from abc a\n" +
                "join abc1 b\n" +
                "on a.name = b.fals;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
