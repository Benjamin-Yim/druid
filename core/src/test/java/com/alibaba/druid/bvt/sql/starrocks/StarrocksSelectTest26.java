...
public class StarrocksSelectTest26 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT count(DISTINCT trackid) AS total, process, value5 AS result\n" +
                ...
                "\t)\n" +
                "GROUP BY process, \n" +
                "\tvalue5", SQLUtils.formatStarrocks(sql));
        ...
        assertEquals("select count(DISTINCT trackid) as total, process, value5 as result\n" +
                ...
                "\t)\n" +
                "group by process, \n" +
                "\tvalue5", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
