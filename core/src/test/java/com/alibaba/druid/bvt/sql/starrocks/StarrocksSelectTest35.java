...
public class StarrocksSelectTest35 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT a.city, a.car_id, a.rrc_id, a.brand, a.car_series\n" +
                ...
                "WHERE status = 'PUBLISHED'\n" +
                "\tAND model_id = 4419\n" +
                "\tAND abs(datediff(licensed_date, '2013-07-01 00:00:00', 'mm')) <= 5;", SQLUtils.formatStarrocks(sql));
        ...
        assertEquals("select a.city, a.car_id, a.rrc_id, a.brand, a.car_series\n" +
                ...
                "where status = 'PUBLISHED'\n" +
                "\tand model_id = 4419\n" +
                "\tand abs(datediff(licensed_date, '2013-07-01 00:00:00', 'mm')) <= 5;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
