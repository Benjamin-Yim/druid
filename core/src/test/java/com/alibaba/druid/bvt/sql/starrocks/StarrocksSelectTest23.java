...
public class StarrocksSelectTest23 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT *\n" +
                ...
                "\tAND (2 = 2\n" +
                "\t\tOR (3 = 3\n" +
                "\t\t\tAND 4 = 4));", SQLUtils.formatStarrocks(sql));
        ...
        assertEquals("select *\n" +
                ...
                "\tand (2 = 2\n" +
                "\t\tor (3 = 3\n" +
                "\t\t\tand 4 = 4));", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
