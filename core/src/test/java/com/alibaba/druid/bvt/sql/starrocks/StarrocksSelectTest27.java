...
public class StarrocksSelectTest27 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT CASE \n" +
                ...
                "\t\tELSE 1\n" +
                "\tEND AS abc\n" +
                "FROM bigdata_xy.dual;", SQLUtils.formatStarrocks(sql));

        assertEquals("select case \n" +
                "\t\twhen aaa < 0.1 then 2\n" +
                "\t\telse 1\n" +
                "\tend as abc\n" +
                "from bigdata_xy.dual;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
