...
public class StarrocksSelectTest24 extends TestCase {
    public void test_select() throws Exception {
        ...
        assertEquals("SELECT ta.member_id AS member_id, ta.city_id\n" +
                ...
                "\tOR t2.order_id IS NOT NULL\n" +
                "GROUP BY t1.member_id, \n" +
                "\tt3.city_id", SQLUtils.formatStarrocks(sql));
        ...
        assertEquals("select ta.member_id as member_id, ta.city_id\n" +
                ...
                "\tor t2.order_id is not null\n" +
                "group by t1.member_id, \n" +
                "\tt3.city_id", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
