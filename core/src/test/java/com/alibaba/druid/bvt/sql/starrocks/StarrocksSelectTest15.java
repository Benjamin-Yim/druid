...
public class StarrocksSelectTest15 extends TestCase {
    public void test_select() throws Exception {
        String sql = "SELECT '\\n' FROM dual;";//
        Assert.assertEquals("SELECT '\\n'" +
                "\nFROM dual;", SQLUtils.formatStarrocks(sql));
        Assert.assertEquals("select '\\n'" +
                "\nfrom dual;", SQLUtils.formatStarrocks(sql, SQLUtils.DEFAULT_LCASE_FORMAT_OPTION));
